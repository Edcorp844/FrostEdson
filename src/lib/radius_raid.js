...
export class Game {
    ...
    set_up_game() {
        const ret = wasm.game_set_up_game(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    render_background1() {
        wasm.game_render_background1(this.__wbg_ptr);
    }
    render_background2() {
        wasm.game_render_background2(this.__wbg_ptr);
    }
    render_background3() {
        wasm.game_render_background3(this.__wbg_ptr);
    }
    render_background4() {
        wasm.game_render_background4(this.__wbg_ptr);
    }
    /**
     ...
     * @param {number} height
     */
    constructor(instance_id, parent_selector, width, height) {
        const ptr0 = passStringToWasm0(parent_selector, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.game_new(instance_id, ptr0, len0, width, height);
        this.__wbg_ptr = ret >>> 0;
        GameFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    init() {
        const ret = wasm.game_init(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    debug_log() {
        wasm.game_debug_log(this.__wbg_ptr);
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_createRadialGradient_4d064a0085f66706 = function() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('radius_raid_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
